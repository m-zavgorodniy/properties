...
//// !! security issue - it creates folder with any name passed with get-parameters
//// !! a big TODO
	$sErrorMsg = CreateServerFolder( $sResourceTypePath . $folderPath ) ;
	if ( $sErrorMsg != '' )
		SendError( 1, "Error creating folder \"{$sResourceTypePath}{$folderPath}\" ({$sErrorMsg})" ) ;
