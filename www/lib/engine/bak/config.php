...
$config['DB_USER'] = 'booclick';
$config['DB_PASSWORD'] = '6YSUnUtY';
$config['DB_DATABASE'] = 'booclick';
...
$config['GALLERY_THUMBNAIL_WIDTH'] = 140;
$config['GALLERY_THUMBNAIL_HEIGHT'] = 100;

$config['MAIL_FROM_NAME'] = 'Booclick Site';
$config['MAIL_FROM_EMAIL'] = 'info@booclick.ru';
...
$config['MAIL_CONTENT_HTTP_HOST'] = 'http://booclick.ru';
