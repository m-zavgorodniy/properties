...
# show credits
$show_credits = false; //true; # set to false to remove credits line. Credits adds 12 pixels to image height
$credits = 'www.captcha.ru'; # if empty, HTTP_HOST will be shown

# CAPTCHA image colors (RGB, 0-255)
$foreground_color = array(23, 28, 38);
$background_color = array(195, 214, 228);
