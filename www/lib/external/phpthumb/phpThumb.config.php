...
//}
////////$PHPTHUMB_CONFIG['cache_directory'] = $_SERVER['DOCUMENT_ROOT'] . '/uploads/images/.phpthumb_cache/';
...
$PHPTHUMB_CONFIG['temp_directory'] = $PHPTHUMB_CONFIG['document_root'] . '/uploads/images/.phpthumb_cache';
...
$PHPTHUMB_CONFIG['error_message_image_default'] = '/images/no_image.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
...
$PHPTHUMB_CONFIG['error_bgcolor']               = 'f8f8f8'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = 'f8f8f8'; // color of text in error messages
